...
<div class="container col-lg-10 col-md-10 pull-left">
      ...
      <h1 class="text-danger">{{$courier->name}}</h1>
...
<div class ="col-lg-2 col-md-2 pull-right">
  ...
  <div class="sidebar-module">
    ...
    <ol class="list-unstyled"><!--No need to add a user in the show.blade-->
      ...
      <li><a href="/students/{{$courier->id}}/edit">Edit</a></li>
...
<li>            
   ...
   <!--   <a   
      ...
      <form id="delete-form" action="{{ route('couriers.destroy',[$courier]) }}" 
...
{{--Delete code ends --}}
  ...
  <div class="sidebar-module">
    ...
    <script type="text/javascript">
     ...
     var result = confirm('Are you sure you wish to delete user: {{$courier}}');//Alert Dialog message
                          if( result ){//If the user clicks on the delete button (onClick())
                                  event.preventDefault();
                                  document.getElementById('delete-form').submit();
                          }
